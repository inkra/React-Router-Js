...
class Petugas extends React.Component {
    constructor(){
        ...
        this.state = {
            petugas : [
                {nip: "19811031 200912 1 001", nama: " Elma Ainayya", alamat: "Jl P Diponegoro, Dki Jakarta", telepon:"081258160625"},
                {nip: "19811031 200912 1 002", nama: "Helia Chessy", alamat: "Jl Letjen TB Simatupang 57, Dki Jakarta", telepon:"081258160625"},
                {nip: "19811031 200912 1 003", nama: "Inara Kalea", alamat: " Jl P Jayakarta 53, Dki Jakarta", telepon:"081258160625"},
            ],
            nip: "",
            nama: "",
            alamat: "",
        ...
        return(
            <div className="petugas">
                <div className="dashboard ms-5"><br></br><br></br>
                    ...
                    <p className='welcome-admin'>OFFICER LIST <br></br>PAYPAY APP.</p>
                    <br></br><br></br>
