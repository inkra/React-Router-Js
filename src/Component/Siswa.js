...
class Siswa extends React.Component {
    constructor(){
        ...
        this.state = {
            siswa : [
                {nis: "100", nama: "Aileen Nathania", alamat: "Jl Imam Bonjol 206, Jawa Tengah"},
                {nis: "101", nama: "Calista Zalfa", alamat: "Jl Jatibaru Raya 77, Dki Jakarta"},
                {nis: "102", nama: "Elvira Askana", alamat: "Jl Mpu Tantular 1 B, Jawa Tengah"},
            ],
            nis: "",
            nama: "",
            alamat: "",
        ...
        return(
            <div className="siswa">
                <div className="dashboard ms-5"><br></br><br></br>
                    ...
                    <p className='welcome-admin'>STUDENT LIST <br></br>PAYPAY APP.</p>
                    <br></br><br></br>
